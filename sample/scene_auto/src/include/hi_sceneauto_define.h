...
//modified by z00271306,2015/01/27
...
typedef struct hiSCENEAUTO_WBATTR_S
{
...
typedef struct hiSCENEAUTO_INIPARAM_ACM_S
{
    HI_BOOL bAcmEnable;
    
    HI_U16 u16HighColorTempAcmOn;
    HI_U16 u16MidColorTempAcmOn;
    HI_U16 u16LowColorTempAcmOn;
    HI_U16 au16HighCCMAcmOn[9];
    HI_U16 au16MidCCMAcmOn[9];
    HI_U16 au16LowCCMAcmOn[9];

    HI_U16 u16HighColorTempAcmOff;
    HI_U16 u16MidColorTempAcmOff;
    HI_U16 u16LowColorTempAcmOff;
    HI_U16 au16HighCCMAcmOff[9];
    HI_U16 au16MidCCMAcmOff[9];
    HI_U16 au16LowCCMAcmOff[9];
}SCENEAUTO_INIPARAM_CCM_S;
...
typedef struct hiSCENEAUTO_INIPARA_S
{
    ...
    SCENEAUTO_INIPARAM_CCM_S stIniCcm;
...
typedef struct hiSCENEAUTO_PREVIOUSPARA_S
{
    ...
    ADPT_SCENEAUTO_3DNR_ATTR_S st3dnr;
